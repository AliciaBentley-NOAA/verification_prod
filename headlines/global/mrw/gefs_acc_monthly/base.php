...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GEFS Anomaly Correlation Coefficient (2017–2024)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/global/mrw/gefs_acc_monthly/pgc.evs.global_ens.acc.hgt_p500.last8years.timeseries_valid00z_06z_12z_18z_f024-f336.nhem.png">
	<span><b>Description:</b> Anomaly Correlation Coefficient (ACC)  measures the skill with which GEFS forecasts capture the large-scale weather pattern. Specifically, an ACC score of 1.0 indicates that the anomalies in the GEFS forecast perfectly represented the observed anomalies. The <b>thin</b> red and black lines represent the average forecast lead time when GEFS forecasts attained an ACC score of 0.8 and 0.6, respectively, during a given month. The <b>thick</b> red and black lines represent the 13-month running average of the forecast lead time when GEFS forecasts attained an ACC score of 0.8 and 0.6, respectively. An upward trend in the lines from left to right indicates that large-scale forecast skill has improved over time.</span> 
</div>
