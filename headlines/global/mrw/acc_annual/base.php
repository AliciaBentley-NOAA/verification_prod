...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Model Anomaly Correlation Coefficient (1984–2023)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/global/gfs/prod/atmos/headline/images/evs.global_det.all_models.acc.hgt_p500.allyears_yearly.timeseries_valid00z_f120.g004_nhem.png">
        <span><b>Description:</b> An Anomaly Correlation Coefficient (ACC) score of 1.0 during a particular year indicates that <u>the 5-day forecasts made during that year</u> were, on average, highly accurate (i.e., essentially perfect) across the Northern Hemisphere. The closer the GFS (black line) is to an ACC score of 1.0 during a particular year, the more accurate the GFS's <u>5-day forecasts</u> were that year. Colored lines represent other weather models, according to the key. An upward trend in a line from left to right indicates that 5-day forecasts have generally improved from 1984 to 2023.</span>
<br>
<br>
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/global/gfs/prod/atmos/headline/images/evs.global_det.gfs_ecmwf.acc.hgt_p500.allyears_yearly.timeseries_valid00z_f120.g004_nhem.png">
        <span><b>Description:</b> An Anomaly Correlation Coefficient (ACC) score of 1.0 during a particular year indicates that <u>the 5-day forecasts made during that year</u> were, on average, highly accurate (i.e., essentially perfect) across the Northern Hemisphere. The closer a weather model is to an ACC score of 1.0 during a particular year, the more accurate that weather model's <u>5-day forecasts</u> were that year. An upward trend in a line from left to right indicates that 5-day forecasts have generally improved from 1984 to 2023.<b> GFS = black line.</b><a style="color:red;"> ECMWF = red line.</a></span>
</div>
