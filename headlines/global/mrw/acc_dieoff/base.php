...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GFS, GEFS, and NAEFS Anomaly Correlation Coefficient Die-off Plot (2023)</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/acc_dieoff/evs.global_ens.acc.hgt_p500.20230101_20240116.fhrmean_bar_valid00z_f384.g003_nhem.png">
</div>
