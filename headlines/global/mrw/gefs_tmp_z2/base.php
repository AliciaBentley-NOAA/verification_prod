...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">GEFS 2-m Temperature Root Mean Square Error (2017–2024)</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/global/mrw/gefs_tmp_z2/pgc.evs.global_ens.rmse.tmp_z2.last8years.timeseries_valid00z_06z_12z_18z_f024-f240.buk_conus.png">
	<span><b>Description:</b> Root Mean Square Error (RMSE) is a measure of the <u>difference between model forecasts and observations</u>. The closer that a point is to an RMSE value of 0.0, the more accurate the 2-m temperature forecasts were over the contiguous U.S. (CONUS) during a given year. Years are shown along the x-axis. RMSE values for Day 1, Day 3, Day 5, and Day 10 forecasts are shown in black, red, blue, and green lines, respectively. Note that short-range GEFS forecasts (e.g., Day 1) have less RMSE (i.e., more skill) than longer-range GEFS forecasts (e.g., Day 10). A decrease in RMSE from left to right indicates that GEFS forecasts have improved over time.</span>
</div>
