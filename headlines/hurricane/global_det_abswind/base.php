...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Deterministic Models: Absolute Intensity (Wind) Error</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/hurricane/2023/evs.hurricane_global_det.abswind_err.al.2023.season.png">
...
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/hurricane/2023/evs.hurricane_global_det.abswind_err.ep.2023.season.png">
...
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/headlines/hurricane/2023/evs.hurricane_global_det.abswind_err.wp.2023.season.png">
