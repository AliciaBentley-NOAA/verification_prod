...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Daily Maximum 8-h Average Bias-Corrected Ozone</a></span>
</div>

<!-- Image -->
<div id="page-map">
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/evs/headline/images/headline_aqm.csi_gt70.ozmax8.l1.last31days.timeseries_init12z_f47.buk_conus.png">
        <span><b>Description:</b> Include Image Description Here</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/evs/headline/images/headline_aqm.csi_gt70.ozmax8.l1.last31days.timeseries_init12z_f47.buk_conus_w.png">
        <span><b>Description:</b> Include Image Description Here</span>
<br>
<br>
<br>
<br>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/evs/headline/images/headline_aqm.csi_gt70.ozmax8.l1.last31days.timeseries_init12z_f47.buk_conus_c.png">
        <span><b>Description:</b> Include Image Description Here</span>
<br>
<br>
<br>
<br>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/evs/headline/images/headline_aqm.csi_gt70.ozmax8.l1.last31days.timeseries_init12z_f47.buk_conus_e.png">
        <span><b>Description:</b> Include Image Description Here</span>
<br>
<br>
<br>
<br>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/evs/headline/images/headline_aqm.csi_gt70.ozmax8.l1.last31days.timeseries_init12z_f47.buk_conus_s.png">
        <span><b>Description:</b> Include Image Description Here</span>
<br>
<br>
<br>
