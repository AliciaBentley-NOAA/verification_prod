...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Forecast Means (raw and bias-corrected) vs. Observation Mean: PM2.5</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.fbar_obar.pm25_l1.last31days.fhrmean_init12z.buk_conus_w.png">
        <span><b>Description:</b> Image shows the hourly-averaged concentration of particulate matter of fine particles with diameters less than 2.5 micrometers (PM2.5) over the western contiguous U.S. during the last 31 days. Forecast hours are shown along the x-axis. The gray dashed line is the observed mean, while the solid black line and solid red line are the raw AQM forecast and the bias-corrected AQM forecast from 12Z runs, respectively. The closer that the forecast mean value is to the observed mean value, the more accurate the PM2.5 forecast was.</span>
<br>
<br>
<br>
<br>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.fbar_obar.pm25_l1.last31days.fhrmean_init12z.buk_conus_c.png">
        <span><b>Description:</b> Similar to the first image, except for the central contiguous U.S. during the last 31 days.</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.fbar_obar.pm25_l1.last31days.fhrmean_init12z.buk_conus_e.png">
        <span><b>Description:</b>  Similar to the first image, except for the eastern contiguous U.S. during the last 31 days.</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.fbar_obar.pm25_l1.last31days.fhrmean_init12z.buk_conus_s.png">
