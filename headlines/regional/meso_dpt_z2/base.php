...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Mesoscale Bias-Corrected Root Mean Square Error and Mean Error (Bias): 2-m Dewpoint</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/headline/images/evs.mesoscale.bcrmse_me.dpt_z2.last90days.fhrmean_init00z.buk_conus_w.png">
...
<br>
<br>
	<image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/headline/images/evs.mesoscale.bcrmse_me.dpt_z2.last90days.fhrmean_init00z.buk_conus_c.png">
        <span><b>Description:</b> A Bias-corrected Root Mean Square Error (BCRMSE; solid line) score of 0.0 represents highly skillful 2-m dewpoint forecasts across the central contiguous United States. A Mean Error (ME; dashed line) of 0.0 represents forecasts that are neither too moist nor too dry.  The y-axis represents the BCRMSE and ME in °F, and the x-axis represents the number of hours between the forecast issuance and valid times (i.e., lead time). Different colored lines represent different models, according to the legend.</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/headline/images/evs.mesoscale.bcrmse_me.dpt_z2.last90days.fhrmean_init00z.buk_conus_e.png">
        <span><b>Description:</b> A Bias-corrected Root Mean Square Error (BCRMSE; solid line) score of 0.0 represents highly skillful 2-m dewpoint forecasts across the eastern contiguous United States. A Mean Error (ME; dashed line) of 0.0 represents forecasts that are neither too moist nor too dry.  The y-axis represents the BCRMSE and ME in °F, and the x-axis represents the number of hours between the forecast issuance and valid times (i.e., lead time). Different colored lines represent different models, according to the legend.</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/headline/images/evs.mesoscale.bcrmse_me.dpt_z2.last90days.fhrmean_init00z.buk_conus_s.png">
	<span><b>Description:</b> A Bias-corrected Root Mean Square Error (BCRMSE; solid line) score of 0.0 represents highly skillful 2-m dewpoint forecasts across the southern contiguous United States. A Mean Error (ME; dashed line) of 0.0 represents forecasts that are neither too moist nor too dry.  The y-axis represents the BCRMSE and ME in °F, and the x-axis represents the number of hours between the forecast issuance and valid times (i.e., lead time). Different colored lines represent different models, according to the legend.</span>
<br>
<br>
<br>
<br>
        <image name="map" style="width:100%" src="https://emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/headline/images/evs.mesoscale.bcrmse_me.dpt_z2.last90days.fhrmean_init00z.alaska.png">
