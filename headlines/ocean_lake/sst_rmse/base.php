...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Sea Surface Temperature (SST) Root Mean Square Error (RMSE)</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <span><center><b>RTOFS Forecast vs. GHRSST Data (Time Series)</b></center></span>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.sst_z0_ghrsst.last90days.timeseries_valid00z_f120.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. NDBC Buoys (Time Series)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.sst_z0_ndbc_standard.last90days.timeseries_valid00z_f120.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. Argo Floats (Time Series)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.temperature_z0_argo.last90days.timeseries_valid00z_f120.glb.png">
        <span><b>Description:</b> Root Mean Square Error (RMSE) measures the difference between model forecasts and observations. The closer that a point is to an RMSE value of 0.0, the more accurate the 120-hour temperature forecast was on a particular valid date. Valid dates are shown along the x-axis.</span>
<br>
<br>
<br>
<br>
...
<br>
        ...
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.sst_z0_ghrsst.last90days.fhrmean_valid00z.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. NDBC Buoys (Mean vs. Forecast Lead Time)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.sst_z0_ndbc_standard.last90days.fhrmean_valid00z.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. Argo Floats (Mean vs. Forecast Lead Time)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.rmse.temperature_z0_argo.last90days.fhrmean_valid00z.glb.png">
        <span><b>Description:</b> Root Mean Square Error (RMSE) measures the difference between model forecasts and observations. The closer that a point is to an RMSE value of 0.0, the more accurate forecasts were. Forecast lengths (i.e., forecast lead times) are shown along the x-axis. The shorter the forcast length, the smaller the RMSE (i.e., the better the forecast).</span>
