...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Arctic Sea Ice Concentration Critical Success Index (≥15%)</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <span><center><b>RTOFS Forecast vs. OSI-SAF (Time Series)</b></center></span>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.csi_ge15.ice_coverage_z0_osisaf.last90days.timeseries_valid00z_f120.arctic.png">
        <span><b>Description:</b> Critical Success Index (CSI) is a measure of the accuracy of a forecast. CSI is a ratio of the number of times RTOFS correctly forecasted sea ice concentration >15% (hit) to the total number of times sea ice concentration >15% was forecasted (hits + false alarms) and missed. The closer CSI to 1 for each particular valid date across the time series, the more accurate RTOFS forecasts for sea ice concentration >15% were. Valid dates are shown along the x-axis.</span>
<br>
<br>
<br>
<br>
        <span><center><b>RTOFS Forecast vs. OSI-SAF (Mean vs. Forecast Lead Time)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.csi_ge15.ice_coverage_z0_osisaf.last90days.fhrmean_valid00z.arctic.png">
        <span><b>Description:</b> Critical Success Index (CSI) is a measure of the accuracy of a forecast. CSI is a ratio of the number of times RTOFS correctly forecasted sea ice concentration >15% (hit) to the total number of times sea ice concentration >15% was forecasted (hits + false alarms) and missed. The closer CSI is to 1 at a particular forecast length, the more accurate RTOFS forecasts of sea ice concentration >15% were. Forecast lengths are shown along the x-axis.</span>
