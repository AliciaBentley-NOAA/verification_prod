...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">Global Sea Surface Temperature (SST) Frequency Bias (≥26.5C)</a></span>
</div>

<!-- Image -->
<div id="page-map">
        <span><center><b>RTOFS Forecast vs. GHRSST Data (Time Series)</b></center></span>
	<image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.sst_z0_ghrsst.last90days.timeseries_valid00z_f120.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. NDBC Buoys (Time Series)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.sst_z0_ndbc_standard.last90days.timeseries_valid00z_f120.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. Argo Floats (Time Series)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.temperature_z0_argo.last90days.timeseries_valid00z_f120.glb.png">
        <span><b>Description:</b> Frequency Bias (FBIAS) is defined as the ratio of the total number of forecasts for an event (hits + false alarms) to the total number of observed events (hits + misses). The perfect value for FBIAS for a specific valid date is 1. An FBIAS less than 1 for temperatures ≥26.5C indicates the event was not forecasted frequently enough while the FBIAS greater than 1 indicates the event was forecasted too frequently. Valid dates are shown along the x-axis. </span>
<br>
<br>
<br>
<br>
...
<br>
        ...
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.sst_z0_ghrsst.last90days.fhrmean_valid00z.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. NDBC Buoys (Mean vs. Forecast Lead Time)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.sst_z0_ndbc_standard.last90days.fhrmean_valid00z.glb.png">
<br>
        <span><center><b>RTOFS Forecast vs. Argo Floats (Mean vs. Forecast Lead Time)</b></center></span>
        <image name="map" style="width:100%" src="https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/headline/images/evs.rtofs.fbias_ge26.5.temperature_z0_argo.last90days.fhrmean_valid00z.glb.png">
        <span><b>Description:</b>  Frequency Bias (FBIAS) is defined as the ratio of the total number of forecasts for an event (hits + false alarms) to the total number of observed events (hits + misses). The perfect value for FBIAS for a specific forecast length is 1. An FBIAS less than 1 for temperatures ≥26.5C indicates the event was not forecasted frequently enough while the FBIAS greater than 1 indicates the event was forecasted too frequently. Forecast lengths (i.e., forecast lead times) are shown along the x-axis. </span>
