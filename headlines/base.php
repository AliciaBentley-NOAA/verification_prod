...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">NOAA/NWS Headline Scores Home</a></span>
</div>
...
<div class="row justify-content-md-center">
	...
	<div class="col-md-auto col-overlay-img">
                <a class="img" href="regional/" target="_top">
                  <div class="img__overlay">NAM<br/>NAM Nest<br>Hi-Res Windows<br>RAP HRRR<br>HREF SREF</div>
                  <img src="icons/regional_hires.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="regional/" target="_top">Regional Models<br>(Short-Range Weather)</a></div>
        </div>
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="hurricane/" target="_top">
                  <div class="img__overlay">HWRF<br>HMON<br>HAFS-A<br>HAFS-B</div>
                  <img src="icons/cyclones.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="hurricane/" target="_top">Hurricane Models</a></div>
        </div>
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="ocean_lake/" target="_top">
                  <div class="img__overlay">RTOFS</div>
                  <img src="icons/ocean_wave.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="ocean_lake/" target="_top">Ocean/Lake Models</a></div>
        </div>
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="air_quality/" target="_top">
                  <div class="img__overlay">AQM</div>
                  <img src="icons/air_quality.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="air_quality/" target="_top">Air Quality Models</a></div>
        </div>
</div>
