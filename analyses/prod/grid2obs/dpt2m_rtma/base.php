...
<!-- Head element -->
<div class="page-top">
    <span><a style="color:#ffffff">RTMA GRID-TO-OBS: 2-M DEW POINT</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.rtma.bcrmse_me.dpt_z2.last31days.vhrmean.buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url1 = "https://www.emc.ncep.noaa.gov/users/verification/analyses/prod/grid2obs/images/evs.rtma.MMM.dpt_LLL.DDD.PPP.RRR.png";
var url2 = "https://www.emc.ncep.noaa.gov/users/verification/analyses/prod/grid2obs/images/evs.rtma.MMM.dpt_LLL.DDD.PPP.RRR.png";
