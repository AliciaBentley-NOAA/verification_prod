...
<!-- Head element -->
<div class="page-top">
    <span><a style="color:#ffffff">URMA GRID-TO-OBS: 10-M GUST</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.urma.bcrmse_me.gust_z10.last31days.vhrmean.buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url1 = "https://www.emc.ncep.noaa.gov/users/verification/analyses/prod/grid2obs/images/evs.urma.MMM.gust_LLL.DDD.PPP.RRR.png";
var url2 = "https://www.emc.ncep.noaa.gov/users/verification/analyses/prod/grid2obs/images/evs.urma.MMM.gust_LLL.DDD.PPP.RRR.png";
