...
<div class="row justify-content-md-center">
    <div class="col-md-auto col-overlay-img">
                <a class="img" href="../verification/headlines/">
                ...
                <div class="img-label"><a class="img-model-icon-lnks" href="../verification/headlines/">Headline Scores</a></div>
        </div>
    <div class="col-md-auto col-overlay-img">
	...
	<div class="col-md-auto col-overlay-img">
        ...
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="hurricane/">
                  <div class="img__overlay">HAFS-A<br>HAFS-B</br>HWRF</br>HMON</div>
                  <img src="style/images/icon/hurricane.png"/>
                </a>
                <div class="img-label"><a class="img-model-icon-lnks" href="hurricane/">Hurricane Models</a></div>
        </div>
	<div class="col-md-auto col-overlay-img">
		<a class="img" href="ocean_lake/">
			<div class="img__overlay">RTOFS<br/>NFCENS</br>GFS-wave</br>GEFS-wave</div>
		  <img src="style/images/icon/ocean_lake.png"/>
		</a>
		<div class="img-label"><a class="img-model-icon-lnks" href="ocean_lake/">Ocean/Lake Models</a></div>
	</div>
        <div class="col-md-auto col-overlay-img">
                <a class="img" href="air_quality/">
			<div class="img__overlay">AQM<br/>GEFS-chem</div>
	...
	<div class="col-md-auto col-overlay-img">
		<a class="img" href="aviation/">
		  <div class="img__overlay">WAFS</div>
		  <img src="style/images/icon/aviation.png"/>
		</a>
		<div class="img-label"><a class="img-model-icon-lnks" href="aviation/">Aviation Products</a></div>
	</div>
        <div class="col-md-auto col-overlay-img">
