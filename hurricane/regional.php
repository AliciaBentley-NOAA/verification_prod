...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_main" src="https://www.emc.ncep.noaa.gov/users/verification/hurricane/2023/regional/al/season/plots/evs.hurricane_regional.abstk_err.al.2023.season.png" style="width:100%">
        </td>
    </tbody>
</table>
</div>
