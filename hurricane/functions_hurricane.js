...
function getURL(year,basin,stormname,model,err,frame){
	...
	for(var i=0; i<5; i++){
		...
		newurl = newurl.replace("ZZZ",frame);
	}
...
function changeLeftregion(id){
	...
	var selected_leftregion = document.getElementById("leftregion").value;
		...
		else if( (selected_year=="2022") && (selected_leftregion=="al") ){
			             region_models = al_2022;
			             region_models_name = al_2022_name;
			        }
	        else if( (selected_year=="2022") && (selected_leftregion=="ep") ){
			             region_models = ep_2022;
			             region_models_name = ep_2022_name;
			        }
                else if( (selected_year=="2023") && (selected_leftregion=="al") ){
                                     region_models = al_2023;
                                     region_models_name = al_2023_name;
                                }
                else if( (selected_year=="2023") && (selected_leftregion=="ep") ){
                                     region_models = ep_2023;
                                     region_models_name = ep_2023_name;
                                }
