...
<!-- Head element -->
<div class="page-top">
    <span><a style="color:#ffffff">GRID-TO-OBS (OCEAN): OCEAN TEMPERATURE</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.rtofs.rmse.temperature_z0_argo.last60days.timeseries_valid00z_f120.glb.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/grid2obs/images/evs.rtofs.MMM.temperature_LLL_OOO.DDD.PPPHHHFFF.RRR.png";

// evs.rtofs.me.temperature_z0_argo.last60days.fhrmean_valid00z.natl.png
