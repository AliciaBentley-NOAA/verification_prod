...
<!-- Head element -->
<div class="page-top">
    <span><a style="color:#ffffff">GRID-TO-GRID (OCEAN): SEA SURFACE HEIGHT</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.rtofs.rmse.ssh_z0_aviso.last60days.timeseries_valid00z_f120.glb.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/grid2grid/images/evs.rtofs.MMM.ssh_LLL_OOO.DDD.PPPHHHFFF.RRR.png";
//var url2 = "https://www.emc.ncep.noaa.gov/users/verification/ocean_lake/rtofs/prod/grid2grid/images/evs.rtofs.MMM.ssh_LLL_OOO.DDD.PPP_validHHHz.RRR.png";

// evs.rtofs.me.ssh_z0_aviso.last60days.fhrmean_valid00z.natl.png
