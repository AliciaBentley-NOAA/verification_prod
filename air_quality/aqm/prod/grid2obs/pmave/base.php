...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): Daily AVG PM<sub>2.5</sub></a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.MMM.pmave.LLL.DDD.PPP_HHH_fFFF.RRR.png";
...
levels.push({
        displayName: "Surface Layer Daily Average",
        name: "a23",
});
t06z_forecasthours = ["22", "46", "70"]
t12z_forecasthours = ["16", "40", "64"]
