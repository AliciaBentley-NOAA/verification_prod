...
// 	}
function getURL(plottype,metric,daterange,inithour,level,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.inithour,imageObj.level,imageObj.region,i);
