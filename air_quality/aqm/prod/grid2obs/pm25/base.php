...
<head>
<meta charset="UTF-8">
<title>AQM Atmospheric Verification - Parallel - G2O: PM<sub>2.5</sub></title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): PM<sub>2.5</sub></a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/air_quality/aqm/prod/grid2obs/images/evs.aqm.MMM.pm25_LLL.DDD.PPP_HHH.RRR.png";
...
metrics.push({
        displayName: "Root Mean Square Error and Bias",
        name: "bcrmse_me",
});
