...
function changePlotType(id){
	...
	else if(selected_plottype=="profile"){
                plottype_forecasthours = profile_forecasthours;
        }
	forecasthours = [];
...
function changeRegion(id){
	...
	var selected_region = document.getElementById("region").value;
        ...
        if (selected_region=="alaska"){
              region_forecasthours = alaska_forecasthours;
        }
        else if (selected_region=="hawaii"){
              region_forecasthours = hawaii_forecasthours;
        }
        else if (selected_region=="prico"){
              region_forecasthours = prico_forecasthours;
        }
        else{
              region_forecasthours = profile_forecasthours;
        }
	forecasthours = [];
        for(i=0; i<region_forecasthours.length; i++){
        forecasthours.push({
                displayName:  region_forecasthours[i].toUpperCase(),
