...
function changePlotType(id){
	...
	if(selected_plottype=="timeseries"){
		plottype_inithours = timeseries_inithours;
		plottype_inithours_name = timeseries_inithours_name;
	}
	else {
		plottype_inithours = non_timeseries_inithours;
		plottype_inithours_name = non_timeseries_inithours_name;
	}
	inithours = [];
	...
	if(selected_inithour=="_init06z"||selected_inithour=="_init18z"){
		plottype_regions = initgroup1_regions;
		plottype_regions_name = initgroup1_regions_name;
	}
	else if(selected_plottype=="timeseries"){
		plottype_regions = timeseries_initgroup2_regions;
		plottype_regions_name = timeseries_initgroup2_regions_name;
	}
	else {
		plottype_regions = non_timeseries_initgroup2_regions;
		plottype_regions_name = non_timeseries_initgroup2_regions_name;
	}
	regions = [];
...
function changeMetric(id){
	...
	//Thresholds
        ...
        var element = document.getElementById("threshold");
        for(i = element.options.length - 1 ; i >= 0 ; i--){element.remove(i);}
        if(selected_metric=="fbias"||selected_metric=="csi"){
                metric_thresholds = threshmean_thresholds;
                metric_thresholds_name = threshmean_thresholds_name;
        }
	...
	for(i = element.options.length - 1 ; i >= 0 ; i--){element.remove(i);}
	if(selected_inithour=="_init06z"||selected_inithour=="_init18z"){
		metric_regions = initgroup1_regions;
		metric_regions_name = initgroup1_regions_name;
	}
	else if(selected_metric=="fbias"||selected_metric=="csi"||selected_metric=="ctc"){
                metric_regions = non_timeseries_initgroup2_regions;
                metric_regions_name = non_timeseries_initgroup2_regions_name;
	}
	else{
		metric_regions = timeseries_initgroup2_regions;
		metric_regions_name = timeseries_initgroup2_regions_name;
	}
	regions = [];
...
function changeInitHour(id){
	...
	for(i=element.options.length - 1 ; i >= 0 ; i--){element.remove(i);}
	if(selected_inithour=="_init06z"||selected_inithour=="_init18z"){
		inithour_forecasthours = initgroup1_forecasthours;
		inithour_forecasthours_name = initgroup1_forecasthours_name;
	}
	else{
		inithour_forecasthours = initgroup2_forecasthours;
		inithour_forecasthours_name = initgroup2_forecasthours_name;
	}
	forecasthours = [];
