...
function getURL(plottype,metric,daterange,inithour,forecasthour,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.inithour,imageObj.forecasthour,imageObj.region,i);
...
function changePlotType(id){
	...
	if(selected_inithour=="_init06z"||selected_inithour=="_init18z"){
		...
		plottype_regions = initgroup2_regions;
		plottype_regions_name = initgroup2_regions;
	}
	regions = [];
...
function changeInitHour(id){
	...
	if(selected_inithour=="_init06z"||selected_inithour=="_init18z"){
		...
		plottype_regions = initgroup2_regions;
		plottype_regions_name = initgroup2_regions_name;
	}
	regions = [];
	for(i=0; i<plottype_regions.length; i++){
	regions.push({
