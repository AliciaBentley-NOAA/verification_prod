...
function changePlotType(id){
	...
	if(selected_plottype=="timeseries"){
		plottype_forecasthours = timeseries_forecasthours;
                ...
                plottype_forecasthours_name = perfdiag_forecasthours_name;
        }
	else if(selected_plottype=="threshmean"){
                plottype_forecasthours = threshmean_forecasthours;
                plottype_forecasthours_name = threshmean_forecasthours_name;
        }
	...
	if( (selected_plottype=="fhrmean") || (selected_plottype=="vertprof_fhrmean")){
        forecasthours.push({
                ...
                name: plottype_forecasthours_name[i],
                })
        }
	else if( (selected_plottype=="perfdiag") || (selected_plottype=="threshmean")){
        forecasthours.push({
