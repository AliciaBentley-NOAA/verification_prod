...
<head>
<meta charset="UTF-8">
<title>Mesoscale Verification - Parallel - G2O: Geopotential Height</title>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/grid2obs/hgt/images/evs.mesoscale.MMM.hgt_LLL.DDD.PPP_initHHHz_fFFF.RRR.png";
...
vertprof_forecasthours = ["000", "006", "012", "018", "024", "030", "036", "042", "048", "054", "060", "066", "072", "078", "084"]
...
function initialize(){
	...
	//changePlotType("vertprof");
	//changeForecastHour("18");
	//changeLevel("p500");
