...
<head>
<meta charset="UTF-8">
<title>Mesoscale Verification - Parallel - G2G: Precipitation</title>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/mesoscale/prod/grid2grid/precip/images/evs.mesoscale.MMMTTTapcp_LLL.DDD.PPP_initHHHz_FFF.RRR.png";
...
accum03_forecasthours = ["f024-f048", "f036-f060", "f048-f072", "f060-f084"]
//accum24_forecasthours = ["f024", "f030", "f036", "f042", "f048", "f054", "f060", "f066", "f072", "f078", "f084"]
accum24_i00Z_forecasthours = ["f036", "f060", "f084"]
accum24_i06Z_forecasthours = ["f030", "f054", "f078"] 
accum24_i12Z_forecasthours = ["f024", "f048", "f072"]
accum24_i18Z_forecasthours = ["f042"]
a01_inithours = ["00", "12"]
a03_inithours = ["00", "12"]
a24_inithours = ["00", "06", "12", "18"]
...
initgroup1_regions_name = ["Alaska", "CONUS", "CONUS - East", "CONUS - West", "CONUS - South", "CONUS - Central"]
initgroup1_regions = ["alaska", "buk_conus", "buk_conus_e", "buk_conus_w", "buk_conus_s", "buk_conus_c"]
//initgroup2_regions_name = ["Alaska"]
//initgroup2_regions = ["alaska"]
//ak_a24_forecasthours = [36,60,84] [30,54,78] [24,48,72], [42]
//====================================================================================================
//Initialize the page
//====================================================================================================
