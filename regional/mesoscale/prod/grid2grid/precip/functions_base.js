...
////
        ...
        if(selected_inithour=="00"){
            if(selected_level=="a01"){
                init_forecasthours = accum01_forecasthours;
            }
            else if(selected_level=="a03"){
                init_forecasthours = accum03_forecasthours;
            }
            else{
                init_forecasthours = accum24_i00Z_forecasthours;
            }
        }
            ...
            if(selected_level=="a01"){
                ...
                init_forecasthours = accum24_i06Z_forecasthours;
            }
        }
            ...
            if(selected_level=="a01"){
                ...
                init_forecasthours = accum24_i12Z_forecasthours;
            }
        }
        else if(selected_inithour=="18"){
            if(selected_level=="a01"){
                init_forecasthours = accum01_forecasthours;
            }
            else if(selected_level=="a03"){
                ...
                init_forecasthours = accum24_i18Z_forecasthours;
            }
        }
        ...
        forecasthours.push({
                displayName:  init_forecasthours[i],
...
function changeLevel(id){
	...
	//Forecast Hour
        ...
        if(selected_level=="a01"){
             ...
             var selected_inithour = document.getElementById("inithour").value;
             var element1 = document.getElementById("inithour");
             for(j = element1.options.length - 1 ; j >= 0 ; j--){element1.remove(j);}
             if(selected_inithour=="00"){
                  level_forecasthours = accum24_i00Z_forecasthours;
             }
             else if(selected_inithour=="06"){
                  level_forecasthours = accum24_i06Z_forecasthours;
             }
             else if(selected_inithour=="12"){
                  level_forecasthours = accum24_i12Z_forecasthours;
             }
             else if(selected_inithour=="18"){
                  level_forecasthours = accum24_i18Z_forecasthours;
             }
	}
	forecasthours = [];
	...
	//Init Hours
        ...
        for(i = element.options.length - 1 ; i >= 0 ; i--){element.remove(i);}
        if(selected_level=="a01"){
                level_inithours = a01_inithours;
        }
        else if(selected_level=="a03"){
                level_inithours = a03_inithours;
        }
	else{
                level_inithours = a24_inithours;
	}
	inithours = [];
