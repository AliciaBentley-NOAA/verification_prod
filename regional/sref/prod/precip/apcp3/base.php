...
<head>
<meta charset="UTF-8">
<title>GFS Atmospheric Verification - Parallel - G2G: Precipitation</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">SREF ~ GEFS: 6hr Accumulated Precip (Threshold mean)</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/sref/prod/images/precip/evs.sref.MMM.TTT.DDD.PPP_valid_HHH.fFFF.buk_conus.png";
...
fields.push({
        displayName: "6hr Accumulated Precip",
        name: "apcp_6a",
});
...
threshmean_forecasthours = ["24","36","48","60","72","84"]
