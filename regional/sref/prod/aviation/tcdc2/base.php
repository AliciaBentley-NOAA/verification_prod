...
<head>
<meta charset="UTF-8">
<title>GFS Atmospheric Verification - Parallel - G2O: Total Cloud</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">SREF ~ GEFS: Total Cloud (Threshold mean)</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/regional/sref/prod/images/grid2obs/evs.sref.MMM.TTT.DDD.PPP.valid_HHH.FFF.buk_conus.png";
...
threshmean_forecasthours = ["f06_to_f27", "f12_to_f39", "f24_to_f51", "f36_to_f63", "f48_to_f75", "f60_to_f87"]
