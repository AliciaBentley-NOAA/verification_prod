...
<head>
<meta charset="UTF-8">
<title>GFS Verification - Production - Atmospheric G2O: 2 meter Dewpoint</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): 2 METER DEWPOINT</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/gfs/prod/atmos/grid2obs/dpt_2m/images/evs.global_det.MMMTTTdpt_z2.DDD.PPPHHHFFF.g104_RRR.png";
...
timeseries_metrics = ["rmse", "me", "fbias"]
timeseries_metrics_name = ["Root Mean Square Error", "Mean Error (Bias)", "Frequency Bias"]
