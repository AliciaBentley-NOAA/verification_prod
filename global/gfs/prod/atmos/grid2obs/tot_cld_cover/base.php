...
<head>
<meta charset="UTF-8">
<title>GFS Verification - Production - Atmospheric G2O: Total Cloud Cover</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): TOTAL CLOUD COVER</a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/gfs/prod/atmos/grid2obs/tot_cld_cover/images/evs.global_det.MMM.tcdc_total.DDD.PPP_validHHHz_fFFF.g104_RRR.png";
...
timeseries_metrics = ["rmse", "me", "fbar_obar"]
timeseries_metrics_name = ["Root Mean Square Error", "Mean Error (Bias)", "Means"]
fhrmean_metrics = ["rmse", "me"]
fhrmean_metrics_name = ["Root Mean Square Error", "Mean Error (Bias)"]
