...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): RELATIVE HUMIDITY</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.global_ens.rmse_spread.rh_p700.last31days.timeseries.valid00z_12z_f360.g003_glb.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/gefs/prod/atmos/grid2obs/images/evs.global_ens.MMM.rh_LLL.DDD.PPP_validHHH_fFFF.g003_RRR.png";
