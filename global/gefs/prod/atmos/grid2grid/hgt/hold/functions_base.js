...
function getURL(plottype,metric,level,daterange,validhour,forecasthour,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.level,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.region,i);
