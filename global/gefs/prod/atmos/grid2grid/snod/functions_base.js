...
function changePlotType(id){
	...
	//Threshold
        ...
        //}
        //else if(selected_metric=="crps") {
	//	plottype_thresholds = crps_thresholds;
        //        plottype_thresholds_name = crps_thresholds_name;
        //}
...
function changeMetric(id){
	...
	if( (selected_metric=="fss_width1") || (selected_metric=="fss_width3") || (selected_metric=="fss_width5") || (selected_metric=="fss_width7") || (selected_metric=="fss_width9") || (selected_metric=="fss_width11")) {
