...
function changePlotType(id){
	...
	//Threshold
        ...
        else if(selected_metric=="me") {
		plottype_thresholds = me_thresholds;
                plottype_thresholds_name = me_thresholds_name;
        }
        else if(selected_metric=="rmse") {
                plottype_thresholds = rmse_thresholds;
                plottype_thresholds_name = rmse_thresholds_name;
        }
