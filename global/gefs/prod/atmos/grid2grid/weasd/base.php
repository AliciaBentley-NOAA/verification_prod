...
<head>
<meta charset="UTF-8">
<title>GEFS Verification - Parallel - Atmospheric G2G: SNOWFALL (WEASD) </title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-GRID (ATMOSPHERIC): SNOWFALL (WEASD) </a></span>
</div>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/gefs/prod/atmos/grid2grid/images/evs.global_ens.MMMTTTweasd_a24.DDD.PPP_validHHHz_fFFF.RRR.png";
...
non_perfdiag_metrics = ["ets", "fbias", "crps", "fss_width1", "fss_width3", "fss_width5", "fss_width7", "fss_width9", "fss_width11"]
non_perfdiag_metrics_name = ["Equitable Threat Score", "Frequency Bias", "Continuous Ranked Probability Score", "Fraction Skill Score - Width 1", "Fraction Skill Score - Width 3", "Fraction Skill Score - Width 5", "Fraction Skill Score - Width 7", "Fraction Skill Score - Width 9", "Fraction Skill Score - Width 11"]
//perfdiag_thresholds = ["."]
//perfdiag_thresholds_name = ["All"]
crps_thresholds = ["."]
crps_thresholds_name=["None"]
non_perfdiag_thresholds = ["_gt0p0254.", "_gt0p1016.", "_gt0p2032.", "_gt0p3048."]
non_perfdiag_thresholds_name = ["> 1 in", "> 4 in ", "> 8 in", "> 12 in"]
