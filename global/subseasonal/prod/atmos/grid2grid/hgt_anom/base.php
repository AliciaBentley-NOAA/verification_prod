...
<title>Subseasonal Verification - Production - Atmospheric G2G: Geopotential Height Anomalies</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-GRID (ATMOSPHERIC): GEOPOTENTIAL HEIGHT ANOMALIES</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="https://www.emc.ncep.noaa.gov/users/verification/global/subseasonal/prod/atmos/grid2grid/images/evs.subseasonal.me.hgt_anom_weeklyavg_p500.last31days.timeseries_valid00z_f168.g003_nhem.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/subseasonal/prod/atmos/grid2grid/images/evs.subseasonal.MMM.hgt_anom_AAAavg_pLLL.DDD.TTT_validHHHz_fFFF.g003_RRR.png";
