...
<head>
<meta charset="UTF-8">
<title>Subseasonal Verification - Production - Atmospheric G2G: Sea Ice Concentration</title>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification/global/subseasonal/prod/atmos/grid2grid/images/evs.subseasonal.MMM.icec_AAAavg_z0.DDD.TTT_validHHHz_fFFF.g003_RRR.png";
...
timeseries_forecasthours = ["168", "336", "504", "672", "720", "840"]
fhrmean_forecasthours = ["840"]
perfdiag_forecasthours = ["168", "336", "504", "672", "720", "840"]
...
non_perfdiag_metrics = ["me", "rmse"]
non_perfdiag_metrics_name = ["Mean Error (Bias)", "Root Mean Square Error"]
fhrmean_avg = ["weekly"]
fhrmean_avg_name = ["Weekly"]
non_fhrmean_avg = ["weekly", "monthly"]
non_fhrmean_avg_name = ["Weekly", "Monthly"]
//====================================================================================================
//Initialize the page
//====================================================================================================
